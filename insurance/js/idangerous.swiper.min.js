...
$(function(){
    var height=0,flag=true;
    window.onload = function(){
        height = $('.content-slide')[0].clientHeight;
        $('.swiper-container').css('height',height+60+'px');

    }
   
    $('.swiper-container .slide').on('touchstart',function(e){
		e.stopPropagation();
	});
    var tabsSwiper = new Swiper('.swiper-container', {
        ...
        onSlideChangeStart: function() {
            ...
            height = $('.content-slide')[tabsSwiper.activeIndex].clientHeight;
            $('.swiper-container').css('height',height+60+'px');	           
        }
    });
